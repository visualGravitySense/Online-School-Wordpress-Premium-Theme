...
function intensiv_scripts() {
	...
	wp_enqueue_script( 'flexslider', get_template_directory_uri() . '/js/libs/flexslider.js', array(), '', true );
    wp_enqueue_script( 'prettyPhoto', get_template_directory_uri() . '/js/libs/prettyPhoto.js', array(), '', true );
    wp_enqueue_script( 'responsiveTabs', get_template_directory_uri() . '/js/libs/responsiveTabs.js', array(), '', true );
    wp_enqueue_script( 'modernizr.custom', get_template_directory_uri() . '/js/libs/modernizr.custom.js', array(), '', true );
    wp_enqueue_script( 'modernizr.custom', get_template_directory_uri() . '/js/libs/modernizr.custom.js', array(), '', true );
    
    wp_enqueue_script( 'intensiv-scripts', get_template_directory_uri() . '/js/libs/script.js', array(), '', true );
